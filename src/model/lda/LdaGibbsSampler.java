...
public class LdaGibbsSampler {
     ...
     * 文档——主题参数
     */
    double alpha = Model1Constant.alpha;

    /**
     * Dirichlet parameter (topic--term associations)<br>
     * 主题——词语参数
     */
    double beta = Model1Constant.beta;
     ...
     * 多久更新一次统计量
     */
    private static int THIN_INTERVAL = Model1Constant.saveStep;

    /**
     * burn-in period<br>
     * 收敛前的迭代次数
     */
    private static int BURN_IN = Model1Constant.beginSaveIters;

    /**
     * max iterations<br>
     * 最大迭代次数
     */
    private static int ITERATIONS = Model1Constant.iteration;
    ...
    public void gibbs(int K) {
        gibbs(K, Model1Constant.alpha, Model1Constant.beta);
    }
...
//                    dispcol++;
//            }
            if (i >= BURN_IN && ((i - BURN_IN) % THIN_INTERVAL) == 0) {
